...
public class Panel extends JPanel {
    ...
    private Image soldadoRojo = new ImageIcon(getClass().getResource("/imagenes/soldadoRojoMini.png")).getImage();
    private Image soldadoAzul = new ImageIcon(getClass().getResource("/imagenes/soldadoAzulMini.png")).getImage();
